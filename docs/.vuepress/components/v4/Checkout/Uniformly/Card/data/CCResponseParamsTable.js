export default {
    data:[
        ...
        {
            "id": 21,
            "value": "threeDHighLevelParams",
            "type": "Object",
            "required": "C",
            "desc": "3DS 验证参数集合\n" +
                "3DS 交易场景下特有，该参数集封装 3DS 验证所需的参数\n" +
                "当需要验证时,参数名作为form 表单的参数名，参数值作为 form 表单的参数值"
        },
        {
            "id": 22,
            ...
            "type": "string(32)",
            "required": "C",
            "desc": "是否需要 3DS (验证处理使用⻛控插件对接的商户使用):<ul><li>true:是</li><li>false:否</li></ul>"
        },
        {
            "id": 23,
            ...
            "type": "Object",
            "required": "C",
            "desc": "3DS 验证参数集合，当交易需要 3DS 验证处理的时 候，将该参数的返回值传入 PingPong 提供的插件 js指定的函数中(使用⻛控插件对接的商户使用)"
        },
        {
            "id": 24,
            "value": "token",
