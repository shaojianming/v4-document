        ...
        },
        {
            ...
            "children": [
                ...
                },
                {
                    ...
                    "type": "string(64)",
                    "required": "C",
                    "desc": "Certificate type of the person using the car:" +
                        "passport" +
                        "id" +
                        "visa" +
                        "driving license"
        ...
        },
        {
            ...
            "children": [
                ...
                },
                {
                    ...
                    "type": "string",
                    "required": "C",
                    "desc": "http accept header information,Example values:text / html, application / xhtml + xml, application / xml;q = 0.9, image / webp, image / apng, *;q = 0.8"
                },
                {
                    "id": 179,
                    "value": "colorDepth",
                ...
                },
                {
                    ...
                    "type": "int",
                    "required": "C",
                    "desc": "screen width, measured in pixels"
                },
                {
                    "id": 189,
                    "value": "javaEnabled",
                    "type": "Boolean",
                    "required": "C",
                    "desc": "cardholder's terminal executing Java。"
                },
                {
                    "id": 190,
                    ...
                    "type": "Boolean",
                    "required": "C",
                    "desc": "cardholder's terminal executing JavaScript default: true "
                }
            ]
        },
        {
