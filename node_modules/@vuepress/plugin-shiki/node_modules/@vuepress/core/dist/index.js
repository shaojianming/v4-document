...
var normalizeClientConfigFileHook = (hook) => async (app) => {
  const clientConfigFileResult = isFunction2(hook) ? await hook(app) : hook;
...
// src/pluginApi/normalizeReturnObjectHook.ts
import { isFunction as isFunction3 } from "@vuepress/shared";
var normalizeReturnObjectHook = (hook) => async (app) => isFunction3(hook) ? hook(app) : hook;
